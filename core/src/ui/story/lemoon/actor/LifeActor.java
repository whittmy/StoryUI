...
public class LifeActor extends Actor{
	...
	public LifeActor(Configer cfg){
		...
		mTextureRegion = MyGame.mCfg.getMainAtlas().findRegion("item_life");
		...
		input = new InputListener(){
			...
			public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
				...
				//Configer.mylog("", "Life up x="+x+", y="+y);
//				MyMsg msg = new MyMsg();
...
//				MyGame.mCfg.game.notify(msg);
			...
			public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
				// TODO Auto-generated method stub
				Configer.mylog("", "Life down x="+x+", y="+y);
	...
	class MyTask extends TimerTask{
		...
		public void run() {
			// TODO Auto-generated method stub
			Configer.mylog("", "cur-tm:"+System.currentTimeMillis());
