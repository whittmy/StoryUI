...
public class MoonActor extends Actor{
	...
	public MoonActor(Configer cfg){
		...
		mMoonFrams[0] = MyGame.mCfg.getMainAtlas().findRegion("night_moon");
//		mMoonFrams[1] = MyGame.mCfg.getMainAtlas().findRegion("sun2");
//		mMoonFrams[2] = MyGame.mCfg.getMainAtlas().findRegion("sun3");
//		mMoonFrams[3] = MyGame.mCfg.getMainAtlas().findRegion("sun4");
//		mMoonFrams[4] = MyGame.mCfg.getMainAtlas().findRegion("sun5");		
