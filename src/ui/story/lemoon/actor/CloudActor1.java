...
public class CloudActor1 extends Actor {
	...
	public CloudActor1(Configer cfg){
		...
		mTrDayCloud = mCfg.mTextureAltas.findRegion("day_cloud");
		mDayW = mTrDayCloud.getRegionWidth()/32;
		mDayH = mTrDayCloud.getRegionHeight()/32;		
		
		mTrNightCloud = mCfg.mTextureAltas.findRegion("night_cloud");
		mNightW = mTrNightCloud.getRegionWidth()/32;
		mNightH = mTrNightCloud.getRegionHeight()/32;
